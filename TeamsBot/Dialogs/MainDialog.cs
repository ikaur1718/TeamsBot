...
namespace TeamsBot.Dialogs
{
    public class MainDialog: LogoutDialog
    {
        ...
        public MainDialog(IConfiguration configuration, ILogger<MainDialog> logger, IGraphClientService graphClientService)
            : base(nameof(MainDialog), configuration["ConnectionName"])
        {
            ...
            AddDialog(new LookupUserwithPhoneDialog(configuration, graphClientService));
            AddDialog(new LookupUserwithExtensionDialog(configuration, graphClientService));
            ...
            CancellationToken cancellationToken)
        {
            var options = new PromptOptions
            {
                ...
                Choices = new List<Choice> {
                    ...
                    new Choice { Value = "Find User with Phone Number" },
                    new Choice { Value = "Find User with Extension" },
            ...
            CancellationToken cancellationToken)
        {
            if (stepContext.Result != null)
            {
                ...
                if (tokenResponse?.Token != null)
                {
                    ...
                    else if (command.StartsWith("Find User with Phone Number"))
                    {
                        return await stepContext.BeginDialogAsync(nameof(LookupUserwithPhoneDialog), null, cancellationToken);
                    }
                    else if (command.StartsWith("Find User with Extension"))
                    {
                        return await stepContext.BeginDialogAsync(nameof(LookupUserwithExtensionDialog), null, cancellationToken);
        ...
        CancellationToken cancellationToken)
            {
                var graphClient = _graphClientService.GetAuthenticatedGraphClient(accessToken);
